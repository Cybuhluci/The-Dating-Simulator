...
//public class PlayerMovementGround : PlayerAttributes
//{
//    void Start()
//    {
...
//    {
//        bool moving = inputHandler.move.magnitude > InputSystem.settings.defaultDeadzoneMin;
...
//            float force = moveVelocity.magnitude <= moveDeadzone
//                ? baseSpeed
//                : acceleration * (1 - (Mathf.Sin(Mathf.Clamp01(speedPercent) * (Mathf.PI / 2)) * Mathf.Max(Vector3.Dot(moveNormal.normalized, moveVelocity.normalized), 0)));

//            accelerationVector = moveNormal
//                * ((wasMoving && moveVelocity.magnitude > moveDeadzone ? force : force / moveNormal.magnitude)
//                * (1 - Mathf.Max(Vector3.Dot(moveNormal.normalized, Vector3.up), 0)));
//        }
...
//        {
//            additiveVelocity += Vector3.Project(-Vector3.up
//                * (Vector3.Dot(moveVelocity, Vector3.up) >= 0
